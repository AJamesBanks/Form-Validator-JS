...
const UIpassword2 = document.getElementById("password2");
...
UIform.addEventListener("submit", function (e) {
  ...
  checkRequired([UIusername, UIemail, UIpassword, UIpassword2]);
  checkLength(UIusername, 3, 15);
  checkLength(UIpassword, 6, 25);
  checkEmail(UIemail);
  checkPasswordsMatch(UIpassword, UIpassword2);
});
